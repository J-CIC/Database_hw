...
class OrderModel extends Model{
    ...
    *@return data_array
    **/
    public function getOrdersTimeDistriubution($level='day'){
        $length_arr = array("year"=>4,"month"=>6,"day"=>8,"hour"=>11,"minute"=>14);
        $length = $length_arr[$level]?$length_arr[$level]:$length_arr["day"];
        $result = $this->field('sum(a_pay_sum) as pay_sum,left(create_time,8) as times')->group('times')->order('pay_sum')->limit(0,20)->select();
